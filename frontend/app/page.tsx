                ...
                <div className="p-4 sm:p-6 space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    {[
                      ...
                      { id: 'REQ-API-023', status: 'Implemented', coverage: '100%', color: 'green' },
                      { id: 'REQ-SEC-008', status: 'Missing', coverage: '0%', color: 'red' },
                    ].map((row, idx) => (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        <div className="col-span-4">
                          <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[9px] sm:text-[10px] font-medium ${row.color === 'green' ? 'bg-green-100 text-green-700 border border-green-200' :
